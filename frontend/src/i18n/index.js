...
const messages = {
  en: {
    ...
    dashboard: {
      ...
      openLink: 'Open',
      ownershipHistoryTitle: 'Ownership history',
      ownershipHistorySubtitle: 'Month-by-month spend across tracked ownership costs.',
      recurringCostsTitle: 'Recurring costs',
      recurringCostsSubtitle: 'Scheduled expenses that repeat over time.',
      photosTitle: 'Photos',
      photosSubtitle: 'Car photos and uploaded visual records.',
      documentsTitle: 'Documents',
      documentsSubtitle: 'Registration, service, and other files.',
      wishlistTitle: 'Marketplace wishlist',
      wishlistSubtitle: 'Parts and upgrades you want to buy later.',
      noOwnershipHistory: 'No ownership history yet.',
      noRecurringCosts: 'No recurring costs yet.',
  ...
  lv: {
    ...
    dashboard: {
      ...
      ownershipTab: 'Īpašumtiesības',
      mediaTab: 'Foto un dokumenti',
      wishlistTab: 'Vēlmju saraksts',
      ...
      month: 'Mēnesis',
      interval: 'Intervāls',
      nextDueDate: 'Nākamais termiņš',
      description: 'Apraksts',
      dateInstalled: 'Uzstādīšanas datums',
      name: 'Nosaukums',
      performanceImpact: 'Veiktspējas ietekme',
      openLink: 'Atvērt',
      ownershipHistoryTitle: 'Īpašumtiesību vēsture',
      ownershipHistorySubtitle: 'Mēneša griezumā uzskaitītās īpašumtiesību izmaksas.',
      recurringCostsTitle: 'Atkārtotās izmaksas',
      recurringCostsSubtitle: 'Plānotie izdevumi, kas atkārtojas laika gaitā.',
      photosTitle: 'Foto',
      photosSubtitle: 'Auto fotoattēli un augšupielādēti vizuālie ieraksti.',
      documentsTitle: 'Dokumenti',
      documentsSubtitle: 'Reģistrācijas, servisa un citi faili.',
      wishlistTitle: 'Marketplace vēlmju saraksts',
      wishlistSubtitle: 'Daļas un uzlabojumi, ko vēlies iegādāties vēlāk.',
      noOwnershipHistory: 'Vēl nav īpašumtiesību vēstures.',
      noRecurringCosts: 'Vēl nav atkārtoto izmaksu.',
      noPhotos: 'Vēl nav foto.',
      noDocuments: 'Vēl nav dokumentu.',
      noWishlistItems: 'Vēl nav vēlmju saraksta ierakstu.',
